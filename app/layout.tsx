...
export const metadata: Metadata = {
	title: 'Ayane Yokoya - Software Developer',
	description:
	...
	authors: [{ name: 'Ayane Yokoya' }],
	creator: 'Ayane Yokoya',
	openGraph: {
		title: 'Ayane Yokoya - Software Developer Portfolio',
		...
		siteName: 'Ayane Yokoya - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Ayane Yokoya - Modern Minimal Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
