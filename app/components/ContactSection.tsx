	...
	return (
		<section className="py-12 md:py-20 bg-gradient-to-b from-purple-900/20 via-purple-900/10 to-transparent">
			<div className="max-w-3xl mx-auto text-center">
				...
				>
					Looking for a motivated software engineer? Let&apos;s connect!
				</motion.p>
				...
				>
					<a
						href="mailto:a-yokoya@outlook.com"
				...
				>
					<a href="https://github.com/ayaneyokoya/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
					...
					<a href="https://www.linkedin.com/in/ayane-yokoya/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
