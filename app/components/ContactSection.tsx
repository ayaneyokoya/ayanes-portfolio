		...
		<section className="py-12 md:py-20 bg-gradient-to-b from-purple-900/20 via-purple-900/10 to-transparent">
			<div className="max-w-3xl mx-auto text-center">
				...
				>
					...
					<a href="https://linkedin.com/ayane-yokoya/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
